...
const FifthBody = () => {
  return (
    <div className="third-body-gradient lg:mt-[6rem] mt-[4rem] flex flex-col items-center pb-10">
      <div className="flex flex-col lg:mt-20 mt-10 font-mono items-center">
        ...
        <h1 className="lg:text-xl text-md w-[80%] lg:w-auto text-left font-mono mt-3 text-gray-700">
